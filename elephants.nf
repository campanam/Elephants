...
process alignMitoSeqs {
	...
	samtools sort -@ ${samtools_extra_threads} -n ${library}.circ_realigned.bam | samtools fixmate -@ ${samtools_extra_threads} -rm -z all - - | samtools sort -@ ${samtools_extra_threads} -o ${library}_vs_mt.bam -
	"""
}
